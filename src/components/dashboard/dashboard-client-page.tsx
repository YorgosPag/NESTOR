...
export function DashboardClientPage({ projects: serverProjects, contacts }: DashboardClientPageProps) {
    ...
    const upcomingDeadlines = activeProjects
        ...
        .map(stage => ({
            ...
            assigneeContactId: stage.assignee
        }));
            ...
            <div className="space-y-8">
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-bold tracking-tight">Πρόσφατα Ενεργά Έργα</h2>
                ...
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-xl font-bold tracking-tight">Πρόσφατες Προσφορές</h2>
                        <Button variant="outline" asChild>
                            <Link href="/projects?tab=quotations">
                                Προβολή Όλων <ArrowRight className="ml-2 h-4 w-4" />
                            </Link>
                        </Button>
                    </div>
